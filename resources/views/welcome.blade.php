@php
    ...
    $posts = [
        ['title' => 'Thi công lắp đặt cửa gỗ nhựa composite tại Hà Nội – Ưu đãi khách hoàn thiện nhà', 'date' => '10/12/2025', 'excerpt' => 'Cửa gỗ nhựa composite được sự chú ý đáng kinh ngạc và được người tiêu dùng đón nhận tích cực nhờ độ bền vượt trội.'],
        ['title' => 'Công ty nhộn nhịp triển khai lắp đặt cửa composite cho khách hàng mùa hoàn thiện nhà cuối năm', 'date' => '26/11/2025', 'excerpt' => 'Cuối năm luôn là thời điểm nhu cầu hoàn thiện và trang hoàng tổ ấm tăng mạnh.'],
        ['title' => 'Thi công lắp các mẫu cửa composite cho khách mùa hoàn thiện nhà cuối năm 2025', 'date' => '15/10/2025', 'excerpt' => 'Cửa Composite chống cong vênh – mối mọt – ẩm mốc vượt trội, phù hợp khí hậu Việt Nam.'],
        ['title' => 'Cập nhật mẫu cửa Composite mới lắp cho khách 2025', 'date' => '28/07/2025', 'excerpt' => 'Bộ sưu tập mẫu cửa composite mới nhất với thiết kế hiện đại, sang trọng.'],
        ['title' => 'Những điều cần biết về cửa gỗ nhựa composite 2025', 'date' => '20/06/2025', 'excerpt' => 'Hiện nay, trên thị trường có đa dạng mẫu mã cửa gỗ, tìm hiểu ưu nhược điểm từng loại.'],
    ];
...
@section('content')
    ...
    {{-- USP banners --}}
    <section class="usp-card position-relative" style="z-index:2;">
        <div class="container">
            <div class="row g-3">
                <div class="col-md-6" data-aos="fade-right">
                    <div class="card border-0 bg-primary text-white shadow">
                        <div class="card-body d-flex align-items-center gap-3 p-4">
                            <div class="fs-1">🚪</div>
                            <div>
                                <h2 class="h5 fw-bold mb-1">Cửa composite cao cấp</h2>
                                <p class="mb-0 small opacity-75">Phủ sơn InChem + Màu tùy ý</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6" data-aos="fade-left">
                    <div class="card border-0 bg-secondary text-white shadow">
                        <div class="card-body d-flex align-items-center gap-3 p-4">
                            <div class="fs-1">💰</div>
                            <div>
                                <h2 class="h5 fw-bold mb-1">Giá cạnh tranh tốt nhất</h2>
                                <p class="mb-0 small opacity-75">Ưu đãi khi mua từ 3 bộ trở lên</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    {{-- Testimonials --}}
    <section class="bg-wood-50 py-3 mt-3">
        <div class="container">
            <h2 class="h3 fw-bold text-wood-800 text-center mb-4" data-aos="fade-up">KHÁCH HÀNG NÓI GÌ VỀ CHÚNG TÔI</h2>
            <div class="row g-4">
                <div class="col-md-6" data-aos="fade-right">
                    <div class="card h-100 border shadow-sm">
                        <div class="card-body">
                            <div class="text-secondary mb-2">★★★★★</div>
                            <p class="text-muted fst-italic mb-3">"Sản phẩm cửa gỗ chịu nước Composite chất lượng tốt, giá hợp lý. Tư vấn nhiệt tình, dịch vụ vận chuyển lắp đặt nhanh, chu đáo."</p>
                            <div class="fw-semibold text-wood-800">Anh Minh</div>
                            <div class="small text-muted">Eurowindow River Park</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6" data-aos="fade-left">
                    <div class="card h-100 border shadow-sm">
                        <div class="card-body">
                            <div class="text-secondary mb-2">★★★★★</div>
                            <p class="text-muted fst-italic mb-3">"Cửa gỗ công nghiệp đa dạng mẫu mã, chất lượng tốt, chịu nước, không co ngót. Tôi tin tưởng đã lắp 20 bộ cho toàn bộ căn nhà."</p>
                            <div class="fw-semibold text-wood-800">Chị Hải</div>
                            <div class="small text-muted">Khu đô thị An Khánh</div>
                        </div>
                    </div>
                </div>
            </div>
